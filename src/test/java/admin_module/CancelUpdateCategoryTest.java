...
import com.ofos.objectrepository.UpdateCategoryPage;

import io.github.bonigarcia.wdm.WebDriverManager;

public class CancelUpdateCategoryTest {
     public static void main(String[] args) throws Throwable {
 	    ...
 	    acp.clickOnSave();
        acp.clickOnUpdate(driver);
        
 	    UpdateCategoryPage ucp = new UpdateCategoryPage(driver);
 	    ucp.clickOnCancel();
